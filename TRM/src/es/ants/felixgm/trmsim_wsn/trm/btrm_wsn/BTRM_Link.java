...
public class BTRM_Link extends Link {
     ...
     * @param initialPheromone The initial pheromone value [NEW]
     */
    public BTRM_Link(BTRM_Sensor source, BTRM_Sensor destination, double initialPheromone) {
    ...
    /**
     * Class BTRM_Link constructor (default)
     * @param source Source sensor of the link
     * @param destination Destination sensor of the link
     */
    ...
    // NEW: Method to update initial value and reset
