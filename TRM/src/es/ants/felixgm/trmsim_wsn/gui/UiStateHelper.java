...
final class UiStateHelper {
    private UiStateHelper() {
    }

    static void syncSliderValue(JSlider slider, JTextField textField) {
        textField.setText(String.valueOf(slider.getValue()));
    }

    static void alignMinMaxSpinners(javax.swing.JSpinner minSpinner, javax.swing.JSpinner maxSpinner, boolean minChanged) {
    ...
    static void setComponentsEnabled(boolean enabled, Component... components) {
    ...
    static void setClientsProbabilityControlsEnabled(boolean enabled, Component label, Component slider, Component textField) {
        label.setEnabled(enabled);
        slider.setEnabled(enabled);
        textField.setEnabled(enabled);
    }

    static void updateParametersSourceView(
            boolean fileSource,
