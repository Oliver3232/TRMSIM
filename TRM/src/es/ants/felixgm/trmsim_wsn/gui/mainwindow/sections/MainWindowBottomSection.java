...
public final class MainWindowBottomSection {
    private MainWindowBottomSection() {
    }

    public static void configureSimulationBottom(JPanel bottomPanel,
    ...
    public static void configureParametersContent(JPanel parametersPanel,
