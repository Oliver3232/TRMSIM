...
import es.ants.felixgm.trmsim_wsn.gui.MainWindowRuntimeSupport;
...
public final class MainWindowConfigurationController {
    ...
    public static void onDelayChanged(Host host) {
    ...
    public static void onRadioRangeChanged(Host host) {
        try {
    ...
    public static NetworkGenerationConfig buildNetworkGenerationConfig(Host host) {
    ...
    public static BatchSimulationConfig buildBatchSimulationConfig(Host host) {
