...
final class SimulationEventHelper {
    interface EventHost {
    ...
    static void runSimulationUpdate(EventHost host, Runnable updateTask) {
        try {
    ...
    static void onNetworkUpdated(EventHost host, Network network) {
    ...
    static void onOutcomesUpdated(EventHost host, Collection<Outcome> outcomes) {
        runSimulationUpdate(host, () -> {
    ...
    static void onMessage(EventHost host, String message) {
        runSimulationUpdate(host, () -> {
    ...
    static void onError(EventHost host, Exception exception) {
