...
public final class ParametersSourceHelper {
    private ParametersSourceHelper() {
    }

    public static void applySelectionState(
    ...
    public static void loadParametersFromSelectedFile(
            Component parent,
    ...
    public static void saveParametersToSelectedFile(
            Component parent,
            Controller controller,
    ...
    public static void applyAndRefreshPanelParameters(
            Component parent,
            Controller controller,
            TRMParametersPanel parametersPanel,
            JTextArea parametersFileContentTextArea) throws Exception {
