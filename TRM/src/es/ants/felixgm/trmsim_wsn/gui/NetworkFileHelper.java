...
final class NetworkFileHelper {
    interface NetworkUiCallbacks {
    ...
    static File chooseXmlFile(Component parent, String startDirectory, String dialogTitle, int dialogType) {
    ...
    static Network loadSelectedNetwork(
            Component parent,
    ...
    static void saveCurrentNetwork(
            Component parent,
            SimulationApplicationService simulationService,
            String filePath) throws Exception {
