...
final class MainWindowControlsSection {
    ...
    static void configure(
        ...
        configureButton(exportDataButton, "Export Data", evt -> MainWindowRenderController.showExportDialog(window), false);
        ...
        trModelComboBox.addItemListener(evt -> MainWindowTrustModelController.handleSelection(window, evt, window.LOGGER));
