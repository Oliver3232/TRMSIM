...
final class MainWindowNodeInspectorController {
    interface Host {
    ...
    static List<MiniLegendPanel.Item> createLegendItems(LegendPanel legendPanel) {
    ...
    static void refreshInspectorLegendPanel(Host host) {
    ...
    static void clearNodeInspector(Host host) {
    ...
    static void selectNodeById(Host host, int nodeId) {
    ...
    static void refreshSelectedNodeDetails(Host host) {
        Integer selectedNodeId = host.getSelectedNodeId();
        if (selectedNodeId == null) {
            clearNodeInspector(host);
            return;
        }
        Sensor sensor = TRMSim_WSN.C.getSensor(selectedNodeId.intValue());
        if (sensor == null) {
            clearNodeInspector(host);
            return;
        }
