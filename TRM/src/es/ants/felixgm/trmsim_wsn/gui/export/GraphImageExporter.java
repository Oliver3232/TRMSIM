...
public class GraphImageExporter {
    public static String exportCurrentGraph(Component parentFrame, OutcomesPanel outcomesPanel, String graphTitle, ExportRequest request) {
        ...
        try {
            String filename = request.resolveFilePath("energy_graph", ".png");
