...
final class TrustModelSelectionHelper {
    ...
    static void updateTrustModelMenuSelection(JMenu trustModelMenu, String trustModelName) {
    ...
    static void configureSelectedTrustModel(
    ...
    static SelectionResult rebuildTrustModelUi(
            String trustModelName,
    ...
    static void resetUiAfterTrustModelSwitch(
            String trustModelName,
