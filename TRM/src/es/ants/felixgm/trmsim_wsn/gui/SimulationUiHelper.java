...
final class SimulationUiHelper {
    private SimulationUiHelper() {
    }

    static void resetOutcomePanels(Collection<OutcomesPanel> outcomesPanels) {
    ...
    static void finishSimulationUi(
    ...
    static void handleSimulationFailure(
            Component parent,
            Exception exception,
